...
export default function SearchBox() {
  ...
  useEffect(() => {
    ...
    setSearchTitlesOnly(searchParams?.get("titlesOnly") === "true")
    setSearchMember(searchParams?.get("author") ?? "")
  }, [searchParams])
    ...
    <div className="search-wrapper-placeholder">
      ...
      >
        <div className="search-input-area">
          <svg className="icon search-icon-left" style={{width:18, height:18}} aria-hidden="true"><use href="/svg/sprites.svg#it-search"></use></svg>
          <input 
            type="search" 
        ...
        <div className="advanced-search-options" aria-hidden={!showSearchPopup}>
          <div className="form-check mb-2 mt-2">
            <input 
              className="form-check-input" type="checkbox" id="sb-titlesOnly" 
              checked={searchTitlesOnly} onChange={(e) => setSearchTitlesOnly(e.target.checked)}
          ...
          <div className="mb-3">
            <label htmlFor="sb-searchMember" className="form-label small text-muted mb-1">Di: Utente</label>
            <input 
              type="text" className="form-control form-control-sm" id="sb-searchMember" 
              placeholder="Nome utente..." value={searchMember} onChange={(e) => setSearchMember(e.target.value)}
